// William Yang
// SequenceMap class is used to map recognition sequences with its corresponding enzyme acronyms.
...
public:
	...
	{
		size_t number_of_enzyme_acronyms = sequence.enzyme_acronyms_.size();
		if (number_of_enzyme_acronyms != 0)
		{

...
// Comparable getElement( x )
// size_t numberOfNodes( )
// size_t internalPathLength( )
// float averageDepth( )
// bool find( x )
// size_t getTotalRecursionCalls( )
...
public:
	...
	{
		return total_recursion_calls_;
	}

	void resetRecursionCounter()
	{
		total_recursion_calls_ = 0;
	}
...
private:
	...
	AvlNode* root;
	size_t total_recursion_calls_ = 0;
...
//			total_recursion_calls_++;
		...
		{
			total_recursion_calls_ += 2;; // 2 function calls, 1 recursive function call (remove).
...
//		rotateWithRightChild(k1);
	...
	/*
	 * Returns the total number of recursive calls to find x.
	 * Function assumes that x exists, if x does not exist, count recursive calls anyways.
	 */
